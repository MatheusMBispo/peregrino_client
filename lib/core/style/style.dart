...
const _secondary = CupertinoColors.activeGreen;
const _tertiary = CupertinoColors.tertiarySystemFill;
const _quaternary = CupertinoColors.quaternarySystemFill;

const _disabled = CupertinoColors.systemGrey;

const _background = Color(0xFF09172B);
const _accent = CupertinoColors.white;
const _accentReverse = CupertinoColors.black;
...
final _lightColorScheme = ColorScheme(
  ...
  // Primary
  primary: _primary,
  onPrimary: _accentReverse,
  primaryContainer: _primary.withOpacity(0.2),
  onPrimaryContainer: _accentReverse,
  // Secondary
  secondary: _secondary,
  onSecondary: _accent,
  secondaryContainer: _secondary.withOpacity(0.2),
  onSecondaryContainer: _tertiary,
  // Error
  error: _red,
  onError: _accent,
  // Background
  background: _background,
  onBackground: _accent,
  // Surface
  surface: _accentReverse,
  onSurface: _quaternary,
  // Outline
  outline: _divider,
);
